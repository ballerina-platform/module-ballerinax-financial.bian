...
public type InternalAuditAssessmentOk record {|
    *http:Ok;
    # body
    InternalAuditAssessment body;
|};

# The Audit test is one aspect that can be intergrated into the overall Audit
public type Audit record {
    ...
    # The Audit specific Business Service
    common:BusinessService BusinessService?;
    # Reference to Audit
    common:Assessment InternalAuditAssessmentReference?;
    # Reference to Audit
    common:Test AuditReference?;
    # The type of Audit
    string AuditType?;
};

public type AuditOk record {|
    *http:Ok;
    # body
    Audit body;
|};
...
public type InternalAuditAssessment record {
    # >
    ...
    common:Featuretypevalues InternalAuditAssessmentParameterType?;
    ...
    common:Feature InternalAuditAssessmentSelectedOption?;
    # >
    # * `Valuation` - 
    # * `Matching` - 
    ...
    common:Instruction InternalAuditAssessmentRequest?;
    # The schedule and timing of the testing performed
    common:Schedule InternalAuditAssessmentSchedule?;
    # InternalAuditAssessmentStatus
    common:Status InternalAuditAssessmentStatus?;
    # InternalAuditAssessmentUsageLog
    common:Log InternalAuditAssessmentUsageLog?;
    # Reference to an entity that assigns and manages the identification.
    # tReference to the organization or agency that issued the identifier (e.g., DMV, Passport Office).
    common:Involvedparty InternalAuditAssessmentServiceProviderReference?;
...
public type LegalComplianceAssessment record {
    # >
    # * `Valuation` - 
    # * `Matching` - 
    # * `Authorization` - An evaluation whether a party or system is allowed to do something.
    ...
    # * `ExternalAgencyCheck` - 
    # * `EntitlementCheck` - Determines what benefit, amount, or service the person is actually entitled to receive once eligibility is confirmed.
    common:Assessmenttypevalues LegalAssessmentType?;
    ...
    common:Workproduct LegalAssessmentWorkProducts?;
    # Outcome/result of the legal assessment, this can include remedial actions
    common:Assessment LegalAssessmentResult?;
};
