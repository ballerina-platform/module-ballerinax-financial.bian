...
public type account_accountrelationshiptypevalues string;

// # accountinvolvementtypevalues
public type accountinvolvementtypevalues string;

// # devicecustomizationtypevalues
public type devicecustomizationtypevalues string;

// # directdebitfrequencyvalues
public type directdebitfrequencyvalues string;

// # directdebittypevalues
public type directdebittypevalues string;

// # feeapplicationfrequencyvalues
public type feeapplicationfrequencyvalues string;

// # feecalculationfrequencyvalues
public type feecalculationfrequencyvalues string;

// # feecalculationmethodtypevalues
public type feecalculationmethodtypevalues string;

// # issueddevicestatustypevalues
public type issueddevicestatustypevalues string;

// # loanproducttypevalues
public type loanproducttypevalues string;

// # modalitytypevalues
public type modalitytypevalues string;

// # paymentinvolvementtypevalues
public type paymentinvolvementtypevalues string;

// # paymenttransactionstatustypevalues
public type paymenttransactionstatustypevalues string;

// # proceduretype
public type proceduretype string;

// # statementtypevalues
public type statementtypevalues string;

// # transactiontype
public type transactiontype string;

// # truefalseindicatorvalues
public type truefalseindicatorvalues string;

// # interestcalculationarrangementmodality
public type interestcalculationarrangementmodality string;

// # paymentprocessingarrangementmodality
public type paymentprocessingarrangementmodality string;

// # servicemodality
public type servicemodality string;

// # servicetype
public type servicetype string;

// # plantype
public type plantype string;
