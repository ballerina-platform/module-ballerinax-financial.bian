...
public type limitarrangement record {
    ...
    # The amount value for the limit arrangement.
    ...
    # The period during which the limit arrangement is valid.
    ...
    # The date and time when the limit arrangement starts.
...
public type accountbalance record {
    # The amount available in the account balance.
    ...
    # The date and time at which the balance value is applicable.
    ...
    # The date and time at which the balance was calculated.
...
public type account record {
    ...
    # The currency details associated with the account.
